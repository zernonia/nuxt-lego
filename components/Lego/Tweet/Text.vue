...
const entities = computed(() => {
  ...
  if (
    tweet.value.entities.media &&
    tweet.value.entities.media[0].indices[0] < tweet.value.display_text_range[1]
  ) {
    tweet.value.display_text_range[1] =
      tweet.value.entities.media[0].indices[0];
  }
